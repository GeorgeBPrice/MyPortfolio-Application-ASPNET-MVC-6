...
6. Masonry
7. Lightbox
8. Countdown (REMOVED, uneeded)
9. Subscribe Form (REMOVED, uneeded)
10. Contact Form (REMOVED, uneeded)
11. Bootstrap
12. Typed text
13. Slider
------------------------------------------------------*/
...
(function($){
  ...
  function personite_navigation(){
    ...
    // Clickable Links   --> disable if using Bootstrap 5
    ...
    // Back to top  --> disable if using Bootstrap 5
